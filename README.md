...
このシステムの設計は、ほとんどが**実測で決めています**。代表的な3つを載せます。
...
> 映像込みでも300台へ300Mbpsを配れました。**頭打ちになるのはCPUではなく通信量です。**
> 台数ごとの数字は
> [ARCHITECTURE.md「規模の頭打ちは、CPUではなく通信量です」](docs/ARCHITECTURE.md#規模の頭打ちはcpuではなく通信量です) にあります。
