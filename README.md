...
生徒の画面はこれだけです。いつでもできるのは、ボタンを押すか、コメントを送るかの2つ。
...
| 高い音が鳴り続ける | ハウリングと思われます。先生のマイクの近くで音を出している端末を「教室から参加」に切り替えると収まります。先生画面はもともと自分の声を鳴らさないので、別の端末から音が出ていることが多いです |
...
[導入を検討する方へ「まず、この表です」](docs/導入を検討する方へ.md#まずこの表です) にまとめてあります。
