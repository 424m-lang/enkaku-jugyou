...
AIによるコメント整理を使用すると、関連する説明や確認できない点などが項目別に表示されます。
...
| 機能 | 説明 |
|---|---|
| **スライド配信** | PDFをアップロードすると、ページ送り・書き込み・ポインターがリアルタイムで同期されます。画面のボタン、矢印キーなど、スライド一覧からページを移動できます |
...
| **コメント整理**（任意） | コメントを受信すると、「関連する説明」「確認できない点」「授業外」「困りごと」「意見・感想」のうち該当する項目を表示します。近い時刻のコメントは1枚のカードにまとめます。カードは対応済みにするまで表示されます（[操作方法](docs/先生向けガイド.md#生徒の反応を見る)） |
...
6. **授業中の操作** — 画面のボタン、キーボード、スライド一覧でページを移動し、必要に応じて書き込みます。コメント整理を使用する場合は、コメントの内容が5項目に整理されます。
